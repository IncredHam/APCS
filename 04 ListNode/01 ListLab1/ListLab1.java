...
public class ListLab1
{
   ...
   public static ListNode insertFirst(ListNode arg, Object p)
   {
      return new ListNode(p, arg);
   }
   public static ListNode insertLast(ListNode arg, Object p)
   {
      ListNode temp = arg;
      while(arg.getNext() != null)
         arg = arg.getNext();
      arg.setNext(new ListNode(p, null));
      return temp;
   }
}
