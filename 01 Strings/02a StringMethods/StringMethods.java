...
public class StringMethods
{
   public static void main(String[] args)
   {
      ...
      for(String str : abra3)
         System.out.println(str+" ");                 // A B R A C A D A B R A
                                                      //
      ...
      */     
      ...
      System.out.println(dateSplit[1] + "-" + dateSplit[0] + "-" + dateSplit[2].substring(2));
      
      /*  String Methods #2  
      2.	Given a line of text, print each word on its own line, but don't 
      print the blank lines.  
      */
      String text = "Fall Sports (football, golf, cheerleading, volleyball, field hockey, cross country) start in 1 week.";
      ...
      */      
      ...
      {
         if(punct.indexOf(str.charAt(k)) >= 0)
         {
            str = str.replace(str.substring(k, k+1), "");
            k = 0;
         }
      }
      System.out.println(str);
      ...
      */      
      ...
      {
         if(letters.indexOf(str2.charAt(k)) < 0)
         {
            str2 = str2.replace(str2.substring(k, k+1), cleaned);
            k = 0;
         }
      }
