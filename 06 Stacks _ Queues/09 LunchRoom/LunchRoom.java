      ...
      for(int i = 0; i < TIME; i++)
      {
         ...
         if(!q.isEmpty())
         {
            if(q.peek().getOrderAndBeServed() == 0)
            {
               ...
               if(thisCustomersTime > lWait[q.peek().getGrade()])
                  lWait[q.peek().getGrade()] = thisCustomersTime;
               aWait[q.peek().getGrade()] += thisCustomersTime;
               q.remove();
            }
            else
